...
public class Bill {
	...
	public int hashCode() {
		...
		result = prime * result + Float.floatToIntBits(cgst);
		...
		result = prime * result + Float.floatToIntBits(sgst);
	...
	public boolean equals(Object obj) {
		...
		if (billMonth == null) {
			...
			return false;
		if (Float.floatToIntBits(cgst) != Float.floatToIntBits(other.cgst))
			return false;
		...
		if (postpaidAccount == null) {
			...
			return false;
		if (Float.floatToIntBits(sgst) != Float.floatToIntBits(other.sgst))
			return false;
